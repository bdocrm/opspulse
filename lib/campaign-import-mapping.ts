export const CAMPAIGN_IMPORT_ALIASES: Record<string, string[]> = {
  ...
  'BDO CIE': ['CI', 'CASH INSTALLMENT', 'CASH INSTALLMENT EASY', 'CI AGENTS MONITORING', 'CI SCORECARD', 'CI HOH MONITORING', 'BDO CIE'],
  'BDO CCC': ['CCC', 'BDO CCC'],
  'BDO NTH CARD': ['NTH CARD', 'XSELL / NTH CARD', 'XSELL/NTH CARD', 'BDO NTH CARD'],
  'BDO SUPPLE': ['SUPPLEMENTARY', 'SUPPLE', 'SUPPLE INVI', 'XSELL / SUPPLE INVI', 'XSELL/SUPPLE INVI', 'BDO SUPPLE'],
  'BDO VC': ['VIRTUAL CARD', 'VIRTUAL', 'XSELL / VIRTUAL', 'XSELL/VIRTUAL', 'BDO VC'],
  'BDO SGM': ['SGM', 'BDO SGM'],
  'RBSC': ['RBSC'],
